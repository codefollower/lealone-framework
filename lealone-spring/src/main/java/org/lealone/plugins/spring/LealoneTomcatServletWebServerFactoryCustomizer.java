 ...
 * @since 2.0.0
 */
public class LealoneTomcatServletWebServerFactoryCustomizer
        implements WebServerFactoryCustomizer<LealoneTomcatServletWebServerFactory>, Ordered {

    private final ServerProperties serverProperties;

    public LealoneTomcatServletWebServerFactoryCustomizer(ServerProperties serverProperties) {
    ...
    @Override
    public void customize(LealoneTomcatServletWebServerFactory factory) {
