...
进入 `lealone-plugins\target` 目录，运行: `java -jar lealone-polyglot-5.1.1.jar`

```java
Lealone version: 5.1.1
Loading config from jar:file:/E:/lealone/lealone-plugins/target/lealone-polyglot-5.1.1.jar!/lealone.yaml
...
运行: `java -jar lealone-polyglot-5.1.1.jar -client`
