...
public class VertxNetUtils {
                ...
                if (vertx == null) {
                    ...
                    if (config.containsKey("blocked_thread_check_interval")) {
                        blockedThreadCheckInterval = Integer
                                .parseInt(config.get("blocked_thread_check_interval"));
    ...
    public static NetServerOptions getNetServerOptions(EncryptionOptions eo) {
        ...
        options.setKeyStoreOptions(
                new JksOptions().setPath(eo.keystore).setPassword(eo.keystore_password));
        ...
        if (eo.truststore != null) {
            ...
            options.setTrustStoreOptions(
                    new JksOptions().setPath(eo.truststore).setPassword(eo.truststore_password));
        }
