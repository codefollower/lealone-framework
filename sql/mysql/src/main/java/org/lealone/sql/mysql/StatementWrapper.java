...
class StatementWrapper extends StatementBase {
    ...
    private void recompileIfRequired() {
        if (statement.needRecompile()) {
            ...
            MySQLParser parser = new MySQLParser(session);
    ...
    public void setReplication(boolean replication) {
        statement.setReplication(replication);
    }

    @Override
    public boolean isReplication() {
        return statement.isReplication();
    }

    @Override
    public void setTransactionName(String transactionName) {
        statement.setTransactionName(transactionName);
    }

    @Override
    public String getTransactionName() {
        return statement.getTransactionName();
    }
}
