...
import org.lealone.sql.mysql.MySQLParser;
...
public class ExpressionColumn extends Expression implements org.lealone.db.expression.ExpressionColumn {
    ...
    public String getSQL(boolean isDistributed) {
        ...
        if (column != null) {
            ...
            sql = quote ? MySQLParser.quoteIdentifier(columnName) : columnName;
        }
        if (tableAlias != null) {
            String a = quote ? MySQLParser.quoteIdentifier(tableAlias) : tableAlias;
            sql = a + "." + sql;
        }
        if (schemaName != null) {
            String s = quote ? MySQLParser.quoteIdentifier(schemaName) : schemaName;
            sql = s + "." + sql;
        }
        return sql;
    }
