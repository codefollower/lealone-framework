...
import org.lealone.sql.mysql.ddl.AlterIndexRename;
import org.lealone.sql.mysql.ddl.AlterSchemaRename;
import org.lealone.sql.mysql.ddl.AlterSchemaWithReplication;
import org.lealone.sql.mysql.ddl.AlterSequence;
import org.lealone.sql.mysql.ddl.AlterTableAddConstraint;
import org.lealone.sql.mysql.ddl.AlterTableAlterColumn;
import org.lealone.sql.mysql.ddl.AlterTableDropConstraint;
import org.lealone.sql.mysql.ddl.AlterTableRename;
import org.lealone.sql.mysql.ddl.AlterTableRenameColumn;
import org.lealone.sql.mysql.ddl.AlterTableSet;
import org.lealone.sql.mysql.ddl.AlterUser;
import org.lealone.sql.mysql.ddl.AlterView;
import org.lealone.sql.mysql.ddl.Analyze;
import org.lealone.sql.mysql.ddl.CreateAggregate;
import org.lealone.sql.mysql.ddl.CreateConstant;
import org.lealone.sql.mysql.ddl.CreateDatabase;
import org.lealone.sql.mysql.ddl.CreateFunctionAlias;
import org.lealone.sql.mysql.ddl.CreateIndex;
import org.lealone.sql.mysql.ddl.CreateRole;
import org.lealone.sql.mysql.ddl.CreateSchema;
import org.lealone.sql.mysql.ddl.CreateSequence;
import org.lealone.sql.mysql.ddl.CreateTable;
import org.lealone.sql.mysql.ddl.CreateTrigger;
import org.lealone.sql.mysql.ddl.CreateUser;
import org.lealone.sql.mysql.ddl.CreateUserDataType;
import org.lealone.sql.mysql.ddl.CreateView;
import org.lealone.sql.mysql.ddl.DeallocateProcedure;
import org.lealone.sql.mysql.ddl.DefineStatement;
import org.lealone.sql.mysql.ddl.DefineStatementWrapper;
import org.lealone.sql.mysql.ddl.DropAggregate;
import org.lealone.sql.mysql.ddl.DropConstant;
import org.lealone.sql.mysql.ddl.DropDatabase;
import org.lealone.sql.mysql.ddl.DropFunctionAlias;
import org.lealone.sql.mysql.ddl.DropIndex;
import org.lealone.sql.mysql.ddl.DropRole;
import org.lealone.sql.mysql.ddl.DropSchema;
import org.lealone.sql.mysql.ddl.DropSequence;
import org.lealone.sql.mysql.ddl.DropTable;
import org.lealone.sql.mysql.ddl.DropTrigger;
import org.lealone.sql.mysql.ddl.DropUser;
import org.lealone.sql.mysql.ddl.DropUserDataType;
import org.lealone.sql.mysql.ddl.DropView;
import org.lealone.sql.mysql.ddl.GrantRevoke;
import org.lealone.sql.mysql.ddl.PrepareProcedure;
import org.lealone.sql.mysql.ddl.SetComment;
import org.lealone.sql.mysql.ddl.TruncateTable;
import org.lealone.sql.mysql.dml.Backup;
import org.lealone.sql.mysql.dml.Call;
import org.lealone.sql.mysql.dml.Delete;
import org.lealone.sql.mysql.dml.ExecuteProcedure;
import org.lealone.sql.mysql.dml.Explain;
import org.lealone.sql.mysql.dml.Insert;
import org.lealone.sql.mysql.dml.Merge;
import org.lealone.sql.mysql.dml.NoOperation;
import org.lealone.sql.mysql.dml.Query;
import org.lealone.sql.mysql.dml.RunScript;
import org.lealone.sql.mysql.dml.Script;
import org.lealone.sql.mysql.dml.Select;
import org.lealone.sql.mysql.dml.SelectUnion;
import org.lealone.sql.mysql.dml.Set;
import org.lealone.sql.mysql.dml.TransactionStatement;
import org.lealone.sql.mysql.dml.Update;
import org.lealone.sql.mysql.expression.Aggregate;
import org.lealone.sql.mysql.expression.Alias;
import org.lealone.sql.mysql.expression.CompareLike;
import org.lealone.sql.mysql.expression.Comparison;
import org.lealone.sql.mysql.expression.ConditionAndOr;
import org.lealone.sql.mysql.expression.ConditionExists;
import org.lealone.sql.mysql.expression.ConditionIn;
import org.lealone.sql.mysql.expression.ConditionInSelect;
import org.lealone.sql.mysql.expression.ConditionNot;
import org.lealone.sql.mysql.expression.Expression;
import org.lealone.sql.mysql.expression.ExpressionColumn;
import org.lealone.sql.mysql.expression.ExpressionList;
import org.lealone.sql.mysql.expression.Function;
import org.lealone.sql.mysql.expression.FunctionCall;
import org.lealone.sql.mysql.expression.JavaAggregate;
import org.lealone.sql.mysql.expression.JavaFunction;
import org.lealone.sql.mysql.expression.Operation;
import org.lealone.sql.mysql.expression.Parameter;
import org.lealone.sql.mysql.expression.Rownum;
import org.lealone.sql.mysql.expression.SequenceValue;
import org.lealone.sql.mysql.expression.Subquery;
import org.lealone.sql.mysql.expression.TableFunction;
import org.lealone.sql.mysql.expression.ValueExpression;
import org.lealone.sql.mysql.expression.Variable;
import org.lealone.sql.mysql.expression.Wildcard;
...
public class MySQLParser implements SQLParser {
    ...
    private StatementBase parseShow() {
        ...
        if (readIf("CLIENT_ENCODING")) {
            ...
            buff.append("* FROM VARIABLES");
            if (readIf("WHERE")) {
                buff.append(" WHERE ");
                // buff.append(readExpression().toString());
                buff.append(sqlCommand.substring(lastParseIndex));
